...
function prepareImages(images, stylesheet, opts) {
	return Q.Promise(function(resolve, reject) {
		...
		resolve([images, stylesheet, opts]);
	});
}
 ...
 * @return {Promise}
 */
function preloadTemplates(images, stylesheet, opts) {

	return Q.Promise(function(resolve, reject) {
		var templates = lodash
			.chain(TEMPLATES)
			.map(function(templatePath, templateKey) {
				if ( !!opts.templates && !!opts.templates[templateKey] ) {
					return {
						key: templateKey,
						fn : lodash.template( opts.templates[templateKey] )
					};
				}
